...
$ar = array(
    ...
    "connectwithfacebook" => "Facebook التسجيل بواسطة",
    //design page
    ...
    //cart
    "goals_texts" => array("اذا طلبت التصميم قبل ان يصل 35 ستحصل على التيشرت و ستكيرز و شهادة ikimuk",
				" اذا طلبت التصميم بعد 35 و قبل 75 ستحصل على التيشرت و ستيكرز",
				"لو طلبت التصميم بعد 75 ستحصل على التيشرت",
				),
    "goals_perks_add" => array("ستيكرز + شهادة ikimuk", "ستيكرز", "."),
    "goals_perks" => array("<ul><li>تيشرت</li><li>ستيكرز</li><li>شهادة ikimuk</li></ul>",
