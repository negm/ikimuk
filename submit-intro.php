...
<div class=" container">
    ...
    <div class="span8">
        ...
        <div class="content">
			...
			<h3 class="titre">2-MAKE IT DIGITAL</h3>
				<p class="par">Turn the idea into a design by using either Photoshop(*.psd) or Illustrator (*.ai).</p>
				<p class="deuxieme ">Just to make sure your design won’t get bounced back to you, make sure it’s compatible with these guidelines!</p>

				<h4 class="soustitre">Guidelines:</h4>
