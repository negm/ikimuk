                            ...
                            <div class="profile_label">
                                <div class="label_content">
                                    <div class="label_thumbnail">
                                        <img src="/images/avatar_40.png"/>
                                    </div>
                                </div>
                            </div>

                            <div class="profile_name">Sevage Malkedjian</div> 
                            <div class="profile_address">Anjar, Lebanon</div>
                            <div class="profile_website">www.sevagmalkedjan.com</div>
                            <div class="profile_twitter">@Sevag Malkedjian</div>
