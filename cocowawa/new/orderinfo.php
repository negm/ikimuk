...
class corder extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('order', 'order', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// user_id
		$this->user_id = new cField('order', 'order', 'x_user_id', 'user_id', '`user_id`', '`user_id`', 20, -1, FALSE, '`user_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->user_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['user_id'] = &$this->user_id;

		// phone
		$this->phone = new cField('order', 'order', 'x_phone', 'phone', '`phone`', '`phone`', 200, -1, FALSE, '`phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['phone'] = &$this->phone;

		// country
		$this->country = new cField('order', 'order', 'x_country', 'country', '`country`', '`country`', 200, -1, FALSE, '`country`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['country'] = &$this->country;

		// region
		$this->region = new cField('order', 'order', 'x_region', 'region', '`region`', '`region`', 200, -1, FALSE, '`region`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['region'] = &$this->region;

		// address
		$this->address = new cField('order', 'order', 'x_address', 'address', '`address`', '`address`', 200, -1, FALSE, '`address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['address'] = &$this->address;

		// status_id
		$this->status_id = new cField('order', 'order', 'x_status_id', 'status_id', '`status_id`', '`status_id`', 16, -1, FALSE, '`status_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->status_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['status_id'] = &$this->status_id;

		// comments
		$this->comments = new cField('order', 'order', 'x_comments', 'comments', '`comments`', '`comments`', 201, -1, FALSE, '`comments`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['comments'] = &$this->comments;

		// last_modified
		$this->last_modified = new cField('order', 'order', 'x_last_modified', 'last_modified', '`last_modified`', 'DATE_FORMAT(`last_modified`, \'%d/%m/%Y %H:%i:%s\')', 135, 7, FALSE, '`last_modified`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("orderedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("orderadd.php", $this->UrlParm($parm));
	}
