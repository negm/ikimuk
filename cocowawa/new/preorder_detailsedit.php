...
$preorder_details_edit = NULL; // Initialize page object first

class cpreorder_details_edit extends cpreorder_details {
	...
	// Page object name
	var $PageObjName = 'preorder_details_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "")
			$this->Page_Terminate("preorder_detailslist.php"); // Invalid key, return to list
		...
		switch ($this->CurrentAction) {
			case "I": // Get a record to display
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("preorder_detailslist.php"); // No matching record, return to list
				}
				break;
			Case "U": // Update
	...
	function LoadFormValues() {
		...
		if (!$this->preorder_id->FldIsDetailKey) {
			$this->preorder_id->setFormValue($objForm->GetValue("x_preorder_id"));
		}
	...
	function RestoreFormValues() {
		...
		$this->preorder_id->CurrentValue = $this->preorder_id->FormValue;
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			// preorder_id
			$this->preorder_id->EditCustomAttributes = "";
			$this->preorder_id->EditValue = ew_HtmlEncode($this->preorder_id->CurrentValue);
	...
	function ValidateForm() {
		...
		if (!EW_SERVER_VALIDATE)
			return ($gsFormError == "");
		if (!is_null($this->preorder_id->FormValue) && $this->preorder_id->FormValue == "") {
			ew_AddMessage($gsFormError, $Language->Phrase("EnterRequiredField") . " - " . $this->preorder_id->FldCaption());
		}
		if (!ew_CheckInteger($this->preorder_id->FormValue)) {
			ew_AddMessage($gsFormError, $this->preorder_id->FldErrMsg());
		}
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// preorder_id
			$this->preorder_id->SetDbValueDef($rsnew, $this->preorder_id->CurrentValue, 0, $this->preorder_id->ReadOnly);
...
// Create page object
if (!isset($preorder_details_edit)) $preorder_details_edit = new cpreorder_details_edit();

// Page init
$preorder_details_edit->Page_Init();

// Page main
$preorder_details_edit->Page_Main();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var preorder_details_edit = new ew_Page("preorder_details_edit");
preorder_details_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = preorder_details_edit.PageID; // For backward compatibility

// Form object
var fpreorder_detailsedit = new ew_Form("fpreorder_detailsedit");

// Validate form
fpreorder_detailsedit.Validate = function(fobj) {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		var infix = "";
		elm = fobj.elements["x" + infix + "_preorder_id"];
		if (elm && !ew_HasValue(elm))
			return ew_OnError(this, elm, ewLanguage.Phrase("EnterRequiredField") + " - <?php echo ew_JsEncode2($preorder_details->preorder_id->FldCaption()) ?>");
		elm = fobj.elements["x" + infix + "_preorder_id"];
		if (elm && !ew_CheckInteger(elm.value))
			return ew_OnError(this, elm, "<?php echo ew_JsEncode2($preorder_details->preorder_id->FldErrMsg()) ?>");
		elm = fobj.elements["x" + infix + "_product_id"];
		if (elm && !ew_HasValue(elm))
			return ew_OnError(this, elm, ewLanguage.Phrase("EnterRequiredField") + " - <?php echo ew_JsEncode2($preorder_details->product_id->FldCaption()) ?>");
		elm = fobj.elements["x" + infix + "_product_id"];
		if (elm && !ew_CheckInteger(elm.value))
			return ew_OnError(this, elm, "<?php echo ew_JsEncode2($preorder_details->product_id->FldErrMsg()) ?>");
		elm = fobj.elements["x" + infix + "_size"];
		if (elm && !ew_HasValue(elm))
			return ew_OnError(this, elm, ewLanguage.Phrase("EnterRequiredField") + " - <?php echo ew_JsEncode2($preorder_details->size->FldCaption()) ?>");
		elm = fobj.elements["x" + infix + "_size"];
		if (elm && !ew_CheckInteger(elm.value))
			return ew_OnError(this, elm, "<?php echo ew_JsEncode2($preorder_details->size->FldErrMsg()) ?>");
		elm = fobj.elements["x" + infix + "_cut"];
		if (elm && !ew_HasValue(elm))
			return ew_OnError(this, elm, ewLanguage.Phrase("EnterRequiredField") + " - <?php echo ew_JsEncode2($preorder_details->cut->FldCaption()) ?>");
		elm = fobj.elements["x" + infix + "_cut"];
		if (elm && !ew_CheckInteger(elm.value))
			return ew_OnError(this, elm, "<?php echo ew_JsEncode2($preorder_details->cut->FldErrMsg()) ?>");
		elm = fobj.elements["x" + infix + "_quantity"];
		if (elm && !ew_HasValue(elm))
			return ew_OnError(this, elm, ewLanguage.Phrase("EnterRequiredField") + " - <?php echo ew_JsEncode2($preorder_details->quantity->FldCaption()) ?>");
		elm = fobj.elements["x" + infix + "_quantity"];
		if (elm && !ew_CheckInteger(elm.value))
			return ew_OnError(this, elm, "<?php echo ew_JsEncode2($preorder_details->quantity->FldErrMsg()) ?>");
		elm = fobj.elements["x" + infix + "_price"];
		if (elm && !ew_HasValue(elm))
			return ew_OnError(this, elm, ewLanguage.Phrase("EnterRequiredField") + " - <?php echo ew_JsEncode2($preorder_details->price->FldCaption()) ?>");
		elm = fobj.elements["x" + infix + "_price"];
		if (elm && !ew_CheckNumber(elm.value))
			return ew_OnError(this, elm, "<?php echo ew_JsEncode2($preorder_details->price->FldErrMsg()) ?>");
		elm = fobj.elements["x" + infix + "_date_added"];
		if (elm && !ew_HasValue(elm))
			return ew_OnError(this, elm, ewLanguage.Phrase("EnterRequiredField") + " - <?php echo ew_JsEncode2($preorder_details->date_added->FldCaption()) ?>");
		elm = fobj.elements["x" + infix + "_date_added"];
		if (elm && !ew_CheckEuroDate(elm.value))
			return ew_OnError(this, elm, "<?php echo ew_JsEncode2($preorder_details->date_added->FldErrMsg()) ?>");
...
fpreorder_detailsedit.Form_CustomValidate =  
...
fpreorder_detailsedit.ValidateRequired = true;
<?php } else { ?>
fpreorder_detailsedit.ValidateRequired = false; 
<?php } ?>
...
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Edit") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $preorder_details->TableCaption() ?></span></p>
<p class="phpmaker"><a href="<?php echo $preorder_details->getReturnUrl() ?>"><?php echo $Language->Phrase("GoBack") ?></a></p>
<?php $preorder_details_edit->ShowPageHeader(); ?>
<?php
$preorder_details_edit->ShowMessage();
?>
<form name="fpreorder_detailsedit" id="fpreorder_detailsedit" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<p>
<input type="hidden" name="t" value="preorder_details">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table cellspacing="0" id="tbl_preorder_detailsedit" class="ewTable">
...
<?php echo $preorder_details->id->EditValue ?></span>
<input type="hidden" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($preorder_details->id->CurrentValue) ?>">
</span><?php echo $preorder_details->id->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($preorder_details->preorder_id->Visible) { // preorder_id ?>
	<tr id="r_preorder_id"<?php echo $preorder_details->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_preorder_details_preorder_id"><?php echo $preorder_details->preorder_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
		<td<?php echo $preorder_details->preorder_id->CellAttributes() ?>><span id="el_preorder_details_preorder_id">
<input type="text" name="x_preorder_id" id="x_preorder_id" size="30" value="<?php echo $preorder_details->preorder_id->EditValue ?>"<?php echo $preorder_details->preorder_id->EditAttributes() ?>>
</span><?php echo $preorder_details->preorder_id->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($preorder_details->product_id->Visible) { // product_id ?>
	<tr id="r_product_id"<?php echo $preorder_details->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_preorder_details_product_id"><?php echo $preorder_details->product_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
		<td<?php echo $preorder_details->product_id->CellAttributes() ?>><span id="el_preorder_details_product_id">
<input type="text" name="x_product_id" id="x_product_id" size="30" value="<?php echo $preorder_details->product_id->EditValue ?>"<?php echo $preorder_details->product_id->EditAttributes() ?>>
</span><?php echo $preorder_details->product_id->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($preorder_details->size->Visible) { // size ?>
	<tr id="r_size"<?php echo $preorder_details->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_preorder_details_size"><?php echo $preorder_details->size->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
		<td<?php echo $preorder_details->size->CellAttributes() ?>><span id="el_preorder_details_size">
<input type="text" name="x_size" id="x_size" size="30" value="<?php echo $preorder_details->size->EditValue ?>"<?php echo $preorder_details->size->EditAttributes() ?>>
</span><?php echo $preorder_details->size->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($preorder_details->cut->Visible) { // cut ?>
	<tr id="r_cut"<?php echo $preorder_details->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_preorder_details_cut"><?php echo $preorder_details->cut->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
		<td<?php echo $preorder_details->cut->CellAttributes() ?>><span id="el_preorder_details_cut">
<input type="text" name="x_cut" id="x_cut" size="30" value="<?php echo $preorder_details->cut->EditValue ?>"<?php echo $preorder_details->cut->EditAttributes() ?>>
</span><?php echo $preorder_details->cut->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($preorder_details->quantity->Visible) { // quantity ?>
	<tr id="r_quantity"<?php echo $preorder_details->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_preorder_details_quantity"><?php echo $preorder_details->quantity->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
		<td<?php echo $preorder_details->quantity->CellAttributes() ?>><span id="el_preorder_details_quantity">
<input type="text" name="x_quantity" id="x_quantity" size="30" value="<?php echo $preorder_details->quantity->EditValue ?>"<?php echo $preorder_details->quantity->EditAttributes() ?>>
</span><?php echo $preorder_details->quantity->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($preorder_details->price->Visible) { // price ?>
	<tr id="r_price"<?php echo $preorder_details->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_preorder_details_price"><?php echo $preorder_details->price->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
		<td<?php echo $preorder_details->price->CellAttributes() ?>><span id="el_preorder_details_price">
<input type="text" name="x_price" id="x_price" size="30" value="<?php echo $preorder_details->price->EditValue ?>"<?php echo $preorder_details->price->EditAttributes() ?>>
</span><?php echo $preorder_details->price->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($preorder_details->date_added->Visible) { // date_added ?>
	<tr id="r_date_added"<?php echo $preorder_details->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_preorder_details_date_added"><?php echo $preorder_details->date_added->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
		<td<?php echo $preorder_details->date_added->CellAttributes() ?>><span id="el_preorder_details_date_added">
<input type="text" name="x_date_added" id="x_date_added" value="<?php echo $preorder_details->date_added->EditValue ?>"<?php echo $preorder_details->date_added->EditAttributes() ?>>
</span><?php echo $preorder_details->date_added->CustomMsg ?></td>
	</tr>
<?php } ?>
</table>
</div>
...
<script type="text/javascript">
fpreorder_detailsedit.Init();
</script>
<?php
$preorder_details_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$preorder_details_edit->Page_Terminate();
?>
