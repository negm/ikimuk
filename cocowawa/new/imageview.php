...
$image_view = NULL; // Initialize page object first

class cimage_view extends cimage {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "imagelist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "imagelist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "imagelist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a name=\"emf_image\" id=\"emf_image\" href=\"javascript:void(0);\" onclick=\"ew_EmailDialogShow({lnk:'emf_image',hdr:ewLanguage.Phrase('ExportToEmail'),key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($image_view)) $image_view = new cimage_view();
...
// Form object
var fimageview = new ew_Form("fimageview");

// Form_CustomValidate event
fimageview.Form_CustomValidate =  
...
fimageview.ValidateRequired = true;
<?php } else { ?>
fimageview.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("View") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $image->TableCaption() ?>&nbsp;&nbsp;</span><?php $image_view->ExportOptions->Render("body"); ?>
</p>
<?php if ($image->Export == "") { ?>
<p class="phpmaker">
<a href="<?php echo $image_view->ListUrl ?>"><?php echo $Language->Phrase("BackToList") ?></a>&nbsp;
<?php if ($Security->IsLoggedIn()) { ?>
<?php if ($image_view->AddUrl <> "") { ?>
<a href="<?php echo $image_view->AddUrl ?>"><?php echo $Language->Phrase("ViewPageAddLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
<?php if ($Security->IsLoggedIn()) { ?>
<?php if ($image_view->EditUrl <> "") { ?>
<a href="<?php echo $image_view->EditUrl ?>"><?php echo $Language->Phrase("ViewPageEditLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
<?php if ($Security->IsLoggedIn()) { ?>
<?php if ($image_view->CopyUrl <> "") { ?>
<a href="<?php echo $image_view->CopyUrl ?>"><?php echo $Language->Phrase("ViewPageCopyLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
</p>
<?php } ?>
...
?>
<form name="fimageview" id="fimageview" class="ewForm" action="" method="post">
<input type="hidden" name="t" value="image">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table cellspacing="0" id="tbl_imageview" class="ewTable">
...
<?php echo $image->title->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $image->desc->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $image->product_id->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
</table>
