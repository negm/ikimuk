...
//
class csubmissions extends cTable {
	var $id;
	var $competition_id;
	var $user_id;
	var $title;
	...
	function __construct() {
		...
		// id
		$this->id = new cField('submissions', 'submissions', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// competition_id
		$this->competition_id = new cField('submissions', 'submissions', 'x_competition_id', 'competition_id', '`competition_id`', '`competition_id`', 3, -1, FALSE, '`competition_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->competition_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['competition_id'] = &$this->competition_id;

		// user_id
		$this->user_id = new cField('submissions', 'submissions', 'x_user_id', 'user_id', '`user_id`', '`user_id`', 20, -1, FALSE, '`user_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->user_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['user_id'] = &$this->user_id;

		// title
		$this->title = new cField('submissions', 'submissions', 'x_title', 'title', '`title`', '`title`', 200, -1, FALSE, '`title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['title'] = &$this->title;

		// comments
		$this->comments = new cField('submissions', 'submissions', 'x_comments', 'comments', '`comments`', '`comments`', 200, -1, FALSE, '`comments`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['comments'] = &$this->comments;

		// newsletter
		$this->newsletter = new cField('submissions', 'submissions', 'x_newsletter', 'newsletter', '`newsletter`', '`newsletter`', 16, -1, FALSE, '`newsletter`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->newsletter->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['newsletter'] = &$this->newsletter;

		// submission_date
		$this->submission_date = new cField('submissions', 'submissions', 'x_submission_date', 'submission_date', '`submission_date`', 'DATE_FORMAT(`submission_date`, \'%d/%m/%Y %H:%i:%s\')', 135, 7, FALSE, '`submission_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->submission_date->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("submissionsview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "submissionsadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("submissionsedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("submissionsadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("submissionsdelete.php", $this->UrlParm());
	}
