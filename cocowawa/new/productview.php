...
class cproduct_view extends cproduct {
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a name=\"emf_product\" id=\"emf_product\" href=\"javascript:void(0);\" onclick=\"ew_EmailDialogShow({lnk:'emf_product',hdr:ewLanguage.Phrase('ExportToEmail'),key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
// Page object
var product_view = new ew_Page("product_view");
product_view.PageID = "view"; // Page ID
var EW_PAGE_ID = product_view.PageID; // For backward compatibility

// Form object
var fproductview = new ew_Form("fproductview");
...
fproductview.ValidateRequired = true;
<?php } else { ?>
fproductview.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("View") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $product->TableCaption() ?>&nbsp;&nbsp;</span><?php $product_view->ExportOptions->Render("body"); ?>
</p>
<?php if ($product->Export == "") { ?>
<p class="phpmaker">
<a href="<?php echo $product_view->ListUrl ?>"><?php echo $Language->Phrase("BackToList") ?></a>&nbsp;
<?php if ($Security->IsLoggedIn()) { ?>
<?php if ($product_view->AddUrl <> "") { ?>
<a href="<?php echo $product_view->AddUrl ?>"><?php echo $Language->Phrase("ViewPageAddLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
<?php if ($Security->IsLoggedIn()) { ?>
<?php if ($product_view->EditUrl <> "") { ?>
<a href="<?php echo $product_view->EditUrl ?>"><?php echo $Language->Phrase("ViewPageEditLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
<?php if ($Security->IsLoggedIn()) { ?>
<?php if ($product_view->CopyUrl <> "") { ?>
<a href="<?php echo $product_view->CopyUrl ?>"><?php echo $Language->Phrase("ViewPageCopyLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
</p>
<?php } ?>
...
?>
<form name="fproductview" id="fproductview" class="ewForm" action="" method="post">
<input type="hidden" name="t" value="product">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table cellspacing="0" id="tbl_productview" class="ewTable">
...
<?php echo $product->order->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
<?php if ($product->last_modified->Visible) { // last_modified ?>
	<tr id="r_last_modified"<?php echo $product->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_product_last_modified"><?php echo $product->last_modified->FldCaption() ?></span></td>
...
<?php echo $product->last_modified->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
</table>
