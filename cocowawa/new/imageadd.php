...
$image_add = NULL; // Initialize page object first

class cimage_add extends cimage {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "imageview.php")
	...
	function LoadDefaultValues() {
		$this->primary->CurrentValue = 0;
		$this->rollover->CurrentValue = 0;
		$this->small->CurrentValue = 1;
	...
	function AddRow($rsold = NULL) {
		...
		// primary
		$this->primary->SetDbValueDef($rsnew, $this->primary->CurrentValue, 0, strval($this->primary->CurrentValue) == "");

		// rollover
		$this->rollover->SetDbValueDef($rsnew, $this->rollover->CurrentValue, 0, strval($this->rollover->CurrentValue) == "");

		// small
		$this->small->SetDbValueDef($rsnew, $this->small->CurrentValue, 0, strval($this->small->CurrentValue) == "");
...
// Create page object
if (!isset($image_add)) $image_add = new cimage_add();
...
// Form object
var fimageadd = new ew_Form("fimageadd");

// Validate form
fimageadd.Validate = function(fobj) {
...
fimageadd.ValidateRequired = true;
<?php } else { ?>
fimageadd.ValidateRequired = false; 
<?php } ?>
...
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $image->TableCaption() ?></span></p>
...
?>
<form name="fimageadd" id="fimageadd" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<p>
<input type="hidden" name="t" value="image">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table cellspacing="0" id="tbl_imageadd" class="ewTable">
