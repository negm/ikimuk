...
define("EW_PROJECT_ID", "{0CA276D3-D17C-410E-8A7B-A18E811C9C5A}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'xXajKoSFQ5vkXoQu', TRUE); // Random key for encryption
...
// Security
define("EW_ADMIN_USER_NAME", "my-coco", TRUE); // Administrator user name
define("EW_ADMIN_PASSWORD", "Sqp.2012.rid.admin.3+++", TRUE); // Administrator password
