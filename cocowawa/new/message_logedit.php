...
$message_log_edit = NULL; // Initialize page object first

class cmessage_log_edit extends cmessage_log {
	...
	// Page object name
	var $PageObjName = 'message_log_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "")
			$this->Page_Terminate("message_loglist.php"); // Invalid key, return to list
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// messageId
			$this->messageId->SetDbValueDef($rsnew, $this->messageId->CurrentValue, NULL, $this->messageId->ReadOnly);

			// requestId
			$this->requestId->SetDbValueDef($rsnew, $this->requestId->CurrentValue, NULL, $this->requestId->ReadOnly);

			// recepient
			$this->recepient->SetDbValueDef($rsnew, $this->recepient->CurrentValue, NULL, $this->recepient->ReadOnly);
...
// Create page object
if (!isset($message_log_edit)) $message_log_edit = new cmessage_log_edit();

// Page init
$message_log_edit->Page_Init();

// Page main
$message_log_edit->Page_Main();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var message_log_edit = new ew_Page("message_log_edit");
message_log_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = message_log_edit.PageID; // For backward compatibility

// Form object
var fmessage_logedit = new ew_Form("fmessage_logedit");

// Validate form
fmessage_logedit.Validate = function(fobj) {
...
fmessage_logedit.Form_CustomValidate =  
...
fmessage_logedit.ValidateRequired = true;
<?php } else { ?>
fmessage_logedit.ValidateRequired = false; 
<?php } ?>
...
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Edit") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $message_log->TableCaption() ?></span></p>
<p class="phpmaker"><a href="<?php echo $message_log->getReturnUrl() ?>"><?php echo $Language->Phrase("GoBack") ?></a></p>
<?php $message_log_edit->ShowPageHeader(); ?>
<?php
$message_log_edit->ShowMessage();
?>
<form name="fmessage_logedit" id="fmessage_logedit" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<p>
<input type="hidden" name="t" value="message_log">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table cellspacing="0" id="tbl_message_logedit" class="ewTable">
...
<?php echo $message_log->id->EditValue ?></span>
<input type="hidden" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($message_log->id->CurrentValue) ?>">
</span><?php echo $message_log->id->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fmessage_logedit.Init();
</script>
<?php
$message_log_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$message_log_edit->Page_Terminate();
?>
