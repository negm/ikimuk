...
$preorder_details_add = NULL; // Initialize page object first

class cpreorder_details_add extends cpreorder_details {
	...
	// Page object name
	var $PageObjName = 'preorder_details_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "preorder_detailsview.php")
	...
	function LoadDefaultValues() {
		$this->preorder_id->CurrentValue = NULL;
		$this->preorder_id->OldValue = $this->preorder_id->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// preorder_id
		$this->preorder_id->SetDbValueDef($rsnew, $this->preorder_id->CurrentValue, 0, FALSE);
...
// Create page object
if (!isset($preorder_details_add)) $preorder_details_add = new cpreorder_details_add();

// Page init
$preorder_details_add->Page_Init();

// Page main
$preorder_details_add->Page_Main();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var preorder_details_add = new ew_Page("preorder_details_add");
preorder_details_add.PageID = "add"; // Page ID
var EW_PAGE_ID = preorder_details_add.PageID; // For backward compatibility

// Form object
var fpreorder_detailsadd = new ew_Form("fpreorder_detailsadd");

// Validate form
fpreorder_detailsadd.Validate = function(fobj) {
...
fpreorder_detailsadd.Form_CustomValidate =  
...
fpreorder_detailsadd.ValidateRequired = true;
<?php } else { ?>
fpreorder_detailsadd.ValidateRequired = false; 
<?php } ?>
...
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $preorder_details->TableCaption() ?></span></p>
<p class="phpmaker"><a href="<?php echo $preorder_details->getReturnUrl() ?>"><?php echo $Language->Phrase("GoBack") ?></a></p>
<?php $preorder_details_add->ShowPageHeader(); ?>
<?php
$preorder_details_add->ShowMessage();
?>
<form name="fpreorder_detailsadd" id="fpreorder_detailsadd" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<p>
<input type="hidden" name="t" value="preorder_details">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table cellspacing="0" id="tbl_preorder_detailsadd" class="ewTable">
...
<script type="text/javascript">
fpreorder_detailsadd.Init();
</script>
<?php
$preorder_details_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$preorder_details_add->Page_Terminate();
?>
