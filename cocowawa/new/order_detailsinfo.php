...
class corder_details extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('order_details', 'order_details', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// order_id
		$this->order_id = new cField('order_details', 'order_details', 'x_order_id', 'order_id', '`order_id`', '`order_id`', 3, -1, FALSE, '`order_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->order_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['order_id'] = &$this->order_id;

		// product_id
		$this->product_id = new cField('order_details', 'order_details', 'x_product_id', 'product_id', '`product_id`', '`product_id`', 3, -1, FALSE, '`product_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->product_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['product_id'] = &$this->product_id;

		// size
		$this->size = new cField('order_details', 'order_details', 'x_size', 'size', '`size`', '`size`', 3, -1, FALSE, '`size`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->size->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['size'] = &$this->size;

		// cut
		$this->cut = new cField('order_details', 'order_details', 'x_cut', 'cut', '`cut`', '`cut`', 3, -1, FALSE, '`cut`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->cut->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cut'] = &$this->cut;

		// quantity
		$this->quantity = new cField('order_details', 'order_details', 'x_quantity', 'quantity', '`quantity`', '`quantity`', 3, -1, FALSE, '`quantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->quantity->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['quantity'] = &$this->quantity;

		// price
		$this->price = new cField('order_details', 'order_details', 'x_price', 'price', '`price`', '`price`', 4, -1, FALSE, '`price`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->price->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['price'] = &$this->price;

		// date_added
		$this->date_added = new cField('order_details', 'order_details', 'x_date_added', 'date_added', '`date_added`', 'DATE_FORMAT(`date_added`, \'%d/%m/%Y %H:%i:%s\')', 135, 7, FALSE, '`date_added`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("order_detailsview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "order_detailsadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("order_detailsedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("order_detailsadd.php", $this->UrlParm($parm));
	}
