...
$message_log_view = NULL; // Initialize page object first

class cmessage_log_view extends cmessage_log {
	...
	// Page object name
	var $PageObjName = 'message_log_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "message_loglist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "message_loglist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "message_loglist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a name=\"emf_message_log\" id=\"emf_message_log\" href=\"javascript:void(0);\" onclick=\"ew_EmailDialogShow({lnk:'emf_message_log',hdr:ewLanguage.Phrase('ExportToEmail'),key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($message_log_view)) $message_log_view = new cmessage_log_view();

// Page init
$message_log_view->Page_Init();

// Page main
$message_log_view->Page_Main();
?>
...
// Page object
var message_log_view = new ew_Page("message_log_view");
message_log_view.PageID = "view"; // Page ID
var EW_PAGE_ID = message_log_view.PageID; // For backward compatibility

// Form object
var fmessage_logview = new ew_Form("fmessage_logview");

// Form_CustomValidate event
fmessage_logview.Form_CustomValidate =  
...
fmessage_logview.ValidateRequired = true;
<?php } else { ?>
fmessage_logview.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("View") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $message_log->TableCaption() ?>&nbsp;&nbsp;</span><?php $message_log_view->ExportOptions->Render("body"); ?>
</p>
<?php if ($message_log->Export == "") { ?>
<p class="phpmaker">
<a href="<?php echo $message_log_view->ListUrl ?>"><?php echo $Language->Phrase("BackToList") ?></a>&nbsp;
<?php if ($Security->IsLoggedIn()) { ?>
<?php if ($message_log_view->AddUrl <> "") { ?>
<a href="<?php echo $message_log_view->AddUrl ?>"><?php echo $Language->Phrase("ViewPageAddLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
<?php if ($Security->IsLoggedIn()) { ?>
<?php if ($message_log_view->EditUrl <> "") { ?>
<a href="<?php echo $message_log_view->EditUrl ?>"><?php echo $Language->Phrase("ViewPageEditLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
<?php if ($Security->IsLoggedIn()) { ?>
<?php if ($message_log_view->CopyUrl <> "") { ?>
<a href="<?php echo $message_log_view->CopyUrl ?>"><?php echo $Language->Phrase("ViewPageCopyLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
</p>
<?php } ?>
<?php $message_log_view->ShowPageHeader(); ?>
<?php
$message_log_view->ShowMessage();
?>
<form name="fmessage_logview" id="fmessage_logview" class="ewForm" action="" method="post">
<input type="hidden" name="t" value="message_log">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table cellspacing="0" id="tbl_message_logview" class="ewTable">
<?php if ($message_log->id->Visible) { // id ?>
	<tr id="r_id"<?php echo $message_log->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_message_log_id"><?php echo $message_log->id->FldCaption() ?></span></td>
		<td<?php echo $message_log->id->CellAttributes() ?>><span id="el_message_log_id">
<span<?php echo $message_log->id->ViewAttributes() ?>>
<?php echo $message_log->id->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $message_log->messageId->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $message_log->requestId->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $message_log->recepient->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $message_log->subject->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $message_log->body->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
<?php if ($message_log->date_added->Visible) { // date_added ?>
	<tr id="r_date_added"<?php echo $message_log->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_message_log_date_added"><?php echo $message_log->date_added->FldCaption() ?></span></td>
...
<?php echo $message_log->date_added->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
</table>
...
<p>
<script type="text/javascript">
fmessage_logview.Init();
</script>
<?php
$message_log_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($message_log->Export == "") { ?>
...
<?php
$message_log_view->Page_Terminate();
?>
