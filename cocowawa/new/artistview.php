...
$artist_view = NULL; // Initialize page object first

class cartist_view extends cartist {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "artistlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "artistlist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "artistlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a name=\"emf_artist\" id=\"emf_artist\" href=\"javascript:void(0);\" onclick=\"ew_EmailDialogShow({lnk:'emf_artist',hdr:ewLanguage.Phrase('ExportToEmail'),key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($artist_view)) $artist_view = new cartist_view();

// Page init
$artist_view->Page_Init();

// Page main
$artist_view->Page_Main();
?>
...
// Page object
var artist_view = new ew_Page("artist_view");
artist_view.PageID = "view"; // Page ID
var EW_PAGE_ID = artist_view.PageID; // For backward compatibility

// Form object
var fartistview = new ew_Form("fartistview");

// Form_CustomValidate event
fartistview.Form_CustomValidate =  
...
fartistview.ValidateRequired = true;
<?php } else { ?>
fartistview.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("View") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $artist->TableCaption() ?>&nbsp;&nbsp;</span><?php $artist_view->ExportOptions->Render("body"); ?>
</p>
<?php if ($artist->Export == "") { ?>
<p class="phpmaker">
<a href="<?php echo $artist_view->ListUrl ?>"><?php echo $Language->Phrase("BackToList") ?></a>&nbsp;
<?php if ($Security->IsLoggedIn()) { ?>
<?php if ($artist_view->AddUrl <> "") { ?>
<a href="<?php echo $artist_view->AddUrl ?>"><?php echo $Language->Phrase("ViewPageAddLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
<?php if ($Security->IsLoggedIn()) { ?>
<?php if ($artist_view->EditUrl <> "") { ?>
<a href="<?php echo $artist_view->EditUrl ?>"><?php echo $Language->Phrase("ViewPageEditLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
<?php if ($Security->IsLoggedIn()) { ?>
<?php if ($artist_view->CopyUrl <> "") { ?>
<a href="<?php echo $artist_view->CopyUrl ?>"><?php echo $Language->Phrase("ViewPageCopyLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
</p>
<?php } ?>
<?php $artist_view->ShowPageHeader(); ?>
<?php
$artist_view->ShowMessage();
?>
<form name="fartistview" id="fartistview" class="ewForm" action="" method="post">
<input type="hidden" name="t" value="artist">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table cellspacing="0" id="tbl_artistview" class="ewTable">
<?php if ($artist->id->Visible) { // id ?>
	<tr id="r_id"<?php echo $artist->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_artist_id"><?php echo $artist->id->FldCaption() ?></span></td>
		<td<?php echo $artist->id->CellAttributes() ?>><span id="el_artist_id">
<span<?php echo $artist->id->ViewAttributes() ?>>
<?php echo $artist->id->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
<?php if ($artist->user_id->Visible) { // user_id ?>
	<tr id="r_user_id"<?php echo $artist->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_artist_user_id"><?php echo $artist->user_id->FldCaption() ?></span></td>
		<td<?php echo $artist->user_id->CellAttributes() ?>><span id="el_artist_user_id">
<span<?php echo $artist->user_id->ViewAttributes() ?>>
<?php echo $artist->user_id->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
<?php if ($artist->name->Visible) { // name ?>
	<tr id="r_name"<?php echo $artist->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_artist_name"><?php echo $artist->name->FldCaption() ?></span></td>
		<td<?php echo $artist->name->CellAttributes() ?>><span id="el_artist_name">
<span<?php echo $artist->name->ViewAttributes() ?>>
<?php echo $artist->name->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $artist->image->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $artist->location->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $artist->website->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $artist->twitter->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $artist->facebook->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
</table>
