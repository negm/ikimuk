...
$artist_edit = NULL; // Initialize page object first

class cartist_edit extends cartist {
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "")
			$this->Page_Terminate("artistlist.php"); // Invalid key, return to list
...
// Create page object
if (!isset($artist_edit)) $artist_edit = new cartist_edit();

// Page init
$artist_edit->Page_Init();

// Page main
$artist_edit->Page_Main();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var artist_edit = new ew_Page("artist_edit");
artist_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = artist_edit.PageID; // For backward compatibility

// Form object
var fartistedit = new ew_Form("fartistedit");

// Validate form
fartistedit.Validate = function(fobj) {
...
fartistedit.Form_CustomValidate =  
...
fartistedit.ValidateRequired = true;
<?php } else { ?>
fartistedit.ValidateRequired = false; 
<?php } ?>
...
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Edit") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $artist->TableCaption() ?></span></p>
<p class="phpmaker"><a href="<?php echo $artist->getReturnUrl() ?>"><?php echo $Language->Phrase("GoBack") ?></a></p>
<?php $artist_edit->ShowPageHeader(); ?>
<?php
$artist_edit->ShowMessage();
?>
<form name="fartistedit" id="fartistedit" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<p>
<input type="hidden" name="t" value="artist">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table cellspacing="0" id="tbl_artistedit" class="ewTable">
...
<?php echo $artist->id->EditValue ?></span>
<input type="hidden" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($artist->id->CurrentValue) ?>">
</span><?php echo $artist->id->CustomMsg ?></td>
	</tr>
<?php } ?>
