...
$preorder_add = NULL; // Initialize page object first

class cpreorder_add extends cpreorder {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "preorderview.php")
	...
	function AddRow($rsold = NULL) {
		...
		// total
		$this->total->SetDbValueDef($rsnew, $this->total->CurrentValue, NULL, strval($this->total->CurrentValue) == "");
...
// Create page object
if (!isset($preorder_add)) $preorder_add = new cpreorder_add();

// Page init
$preorder_add->Page_Init();

// Page main
$preorder_add->Page_Main();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var preorder_add = new ew_Page("preorder_add");
preorder_add.PageID = "add"; // Page ID
var EW_PAGE_ID = preorder_add.PageID; // For backward compatibility

// Form object
var fpreorderadd = new ew_Form("fpreorderadd");

// Validate form
fpreorderadd.Validate = function(fobj) {
...
fpreorderadd.Form_CustomValidate =  
...
fpreorderadd.ValidateRequired = true;
<?php } else { ?>
fpreorderadd.ValidateRequired = false; 
<?php } ?>
...
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $preorder->TableCaption() ?></span></p>
<p class="phpmaker"><a href="<?php echo $preorder->getReturnUrl() ?>"><?php echo $Language->Phrase("GoBack") ?></a></p>
<?php $preorder_add->ShowPageHeader(); ?>
<?php
$preorder_add->ShowMessage();
?>
<form name="fpreorderadd" id="fpreorderadd" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<p>
<input type="hidden" name="t" value="preorder">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table cellspacing="0" id="tbl_preorderadd" class="ewTable">
