...
$password_reset_edit = NULL; // Initialize page object first

class cpassword_reset_edit extends cpassword_reset {
	...
	// Page object name
	var $PageObjName = 'password_reset_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "")
			$this->Page_Terminate("password_resetlist.php"); // Invalid key, return to list
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// expire_date
			$this->expire_date->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->expire_date->CurrentValue, 7), ew_CurrentDate(), $this->expire_date->ReadOnly);
...
// Create page object
if (!isset($password_reset_edit)) $password_reset_edit = new cpassword_reset_edit();

// Page init
$password_reset_edit->Page_Init();

// Page main
$password_reset_edit->Page_Main();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var password_reset_edit = new ew_Page("password_reset_edit");
password_reset_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = password_reset_edit.PageID; // For backward compatibility

// Form object
var fpassword_resetedit = new ew_Form("fpassword_resetedit");

// Validate form
fpassword_resetedit.Validate = function(fobj) {
...
fpassword_resetedit.Form_CustomValidate =  
...
fpassword_resetedit.ValidateRequired = true;
<?php } else { ?>
fpassword_resetedit.ValidateRequired = false; 
<?php } ?>
...
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Edit") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $password_reset->TableCaption() ?></span></p>
<p class="phpmaker"><a href="<?php echo $password_reset->getReturnUrl() ?>"><?php echo $Language->Phrase("GoBack") ?></a></p>
<?php $password_reset_edit->ShowPageHeader(); ?>
<?php
$password_reset_edit->ShowMessage();
?>
<form name="fpassword_resetedit" id="fpassword_resetedit" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<p>
<input type="hidden" name="t" value="password_reset">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table cellspacing="0" id="tbl_password_resetedit" class="ewTable">
...
<?php echo $password_reset->id->EditValue ?></span>
<input type="hidden" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($password_reset->id->CurrentValue) ?>">
</span><?php echo $password_reset->id->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fpassword_resetedit.Init();
</script>
<?php
$password_reset_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$password_reset_edit->Page_Terminate();
?>
