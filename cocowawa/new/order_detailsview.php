...
class corder_details_view extends corder_details {
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a name=\"emf_order_details\" id=\"emf_order_details\" href=\"javascript:void(0);\" onclick=\"ew_EmailDialogShow({lnk:'emf_order_details',hdr:ewLanguage.Phrase('ExportToEmail'),key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
// Page object
var order_details_view = new ew_Page("order_details_view");
order_details_view.PageID = "view"; // Page ID
var EW_PAGE_ID = order_details_view.PageID; // For backward compatibility

// Form object
var forder_detailsview = new ew_Form("forder_detailsview");
...
forder_detailsview.ValidateRequired = true;
<?php } else { ?>
forder_detailsview.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("View") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $order_details->TableCaption() ?>&nbsp;&nbsp;</span><?php $order_details_view->ExportOptions->Render("body"); ?>
</p>
<?php if ($order_details->Export == "") { ?>
<p class="phpmaker">
<a href="<?php echo $order_details_view->ListUrl ?>"><?php echo $Language->Phrase("BackToList") ?></a>&nbsp;
<?php if ($Security->IsLoggedIn()) { ?>
<?php if ($order_details_view->AddUrl <> "") { ?>
<a href="<?php echo $order_details_view->AddUrl ?>"><?php echo $Language->Phrase("ViewPageAddLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
<?php if ($Security->IsLoggedIn()) { ?>
<?php if ($order_details_view->EditUrl <> "") { ?>
<a href="<?php echo $order_details_view->EditUrl ?>"><?php echo $Language->Phrase("ViewPageEditLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
<?php if ($Security->IsLoggedIn()) { ?>
<?php if ($order_details_view->CopyUrl <> "") { ?>
<a href="<?php echo $order_details_view->CopyUrl ?>"><?php echo $Language->Phrase("ViewPageCopyLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
</p>
<?php } ?>
...
?>
<form name="forder_detailsview" id="forder_detailsview" class="ewForm" action="" method="post">
<input type="hidden" name="t" value="order_details">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table cellspacing="0" id="tbl_order_detailsview" class="ewTable">
...
<?php echo $order_details->id->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
<?php if ($order_details->order_id->Visible) { // order_id ?>
	<tr id="r_order_id"<?php echo $order_details->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_order_details_order_id"><?php echo $order_details->order_id->FldCaption() ?></span></td>
...
<?php if ($order_details->product_id->Visible) { // product_id ?>
	<tr id="r_product_id"<?php echo $order_details->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_order_details_product_id"><?php echo $order_details->product_id->FldCaption() ?></span></td>
...
<?php echo $order_details->product_id->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
<?php if ($order_details->size->Visible) { // size ?>
	<tr id="r_size"<?php echo $order_details->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_order_details_size"><?php echo $order_details->size->FldCaption() ?></span></td>
...
<?php if ($order_details->price->Visible) { // price ?>
	<tr id="r_price"<?php echo $order_details->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_order_details_price"><?php echo $order_details->price->FldCaption() ?></span></td>
...
<?php if ($order_details->date_added->Visible) { // date_added ?>
	<tr id="r_date_added"<?php echo $order_details->RowAttributes() ?>>
		<td class="ewTableHeader"><span id="elh_order_details_date_added"><?php echo $order_details->date_added->FldCaption() ?></span></td>
...
<?php echo $order_details->date_added->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
</table>
